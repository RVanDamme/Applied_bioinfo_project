...
protlink_data_frame = pd.read_csv('junk/9096.prot.links.over500.txt', sep=' ', header = None)
...
domain_data_frame = pd.read_csv('data/proteins_w_domains.txt', sep='\t', header = 0)
